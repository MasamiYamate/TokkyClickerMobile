...
// in simulator we redefine to format for TokkyClickerMobile Developer console
...
{\
	NSString * exceptionName = [@"org.tokkyclickermobile." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tokkyclickermobile";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITokkyClickerMobileNativeItemNone = -1, 
	UITokkyClickerMobileNativeItemSpinner = -2,
	UITokkyClickerMobileNativeItemProgressBar = -3,
	
	UITokkyClickerMobileNativeItemSlider = -4,
	UITokkyClickerMobileNativeItemSwitch = -5,
	UITokkyClickerMobileNativeItemMultiButton = -6,
	UITokkyClickerMobileNativeItemSegmented = -7,
	
	UITokkyClickerMobileNativeItemTextView = -8,
	UITokkyClickerMobileNativeItemTextField = -9,
	UITokkyClickerMobileNativeItemSearchBar = -10,
	
	UITokkyClickerMobileNativeItemPicker = -11,
	UITokkyClickerMobileNativeItemDatePicker = -12,
	
	UITokkyClickerMobileNativeItemInfoLight = -13,
	UITokkyClickerMobileNativeItemInfoDark = -14,
	
	UITokkyClickerMobileNativeItemDisclosure = -15,
	
	UITokkyClickerMobileNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TokkyClickerMobile instances of
