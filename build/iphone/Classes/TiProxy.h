...
//Rare exceptions to indicate a bug in the _tokkyclickermobile code (Eg, function that a subclass should have implemented)
...
/**
 The base class for TokkyClickerMobile proxies.
 */
