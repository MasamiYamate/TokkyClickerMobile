...
- (NSString*)userAgent
{
	if (userAgent==nil)
	{
		...
		NSString *kTokkyClickerMobileUserAgentPrefix = [NSString stringWithFormat:@"%s%s%s %s%s","Appc","eler","ator","Tita","nium"];
		userAgent = [[NSString stringWithFormat:@"%@/%s (%@)",kTokkyClickerMobileUserAgentPrefix,TI_VERSION_STR,currentDeviceInfo] retain];
	}
	return userAgent;
}
