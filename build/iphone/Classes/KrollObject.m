...
//@interface TokkyClickerMobileObject : NSObject
//@end

@interface TokkyClickerMobileObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TokkyClickerMobileObject class]])
		{
			for (NSString *key in [[(TokkyClickerMobileObject*)o modules] allKeys])
			{
