...
/**
 Base class for all TokkyClickerMobile views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TokkyClickerMobile view hierarchy (such as wrapped iOS UIViews) was touched.
