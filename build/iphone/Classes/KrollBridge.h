...
@interface TokkyClickerMobileObject : KrollCoverageObject {
#else
@interface TokkyClickerMobileObject : KrollObject {
#endif
@private
...
extern NSString * TokkyClickerMobile$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TokkyClickerMobileObject *_tokkyclickermobile;
    KrollObject* console;
	BOOL shutdown;
